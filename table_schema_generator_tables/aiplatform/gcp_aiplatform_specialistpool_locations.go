...
type TableGcpAiplatformSpecialistpoolLocationsGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableGcpAiplatformSpecialistpoolLocationsGenerator{}

func (x *TableGcpAiplatformSpecialistpoolLocationsGenerator) GetTableName() string {
	return "gcp_aiplatform_specialistpool_locations"
}

func (x *TableGcpAiplatformSpecialistpoolLocationsGenerator) GetTableDescription() string {
	return ""
}

func (x *TableGcpAiplatformSpecialistpoolLocationsGenerator) GetVersion() uint64 {
	return 0
}
...
func (x *TableGcpAiplatformSpecialistpoolLocationsGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return nil
}

func (x *TableGcpAiplatformSpecialistpoolLocationsGenerator) GetColumns() []*schema.Column {
...
func (x *TableGcpAiplatformSpecialistpoolLocationsGenerator) GetSubTables() []*schema.Table {
	return []*schema.Table{
		table_schema_generator.GenTableSchema(&TableGcpAiplatformSpecialistPoolsGenerator{}),
	}
}
